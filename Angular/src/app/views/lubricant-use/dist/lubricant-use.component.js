...
var LubricantUseComponent = /** @class */ (function () {
    function LubricantUseComponent(_fb, _lus, _activatedRoute, _snackBar, router, appService) {
        this._fb = _fb;
        this._lus = _lus;
        ...
        this.columnNames = [
            { id: "lubricantName", value: "Lime Type", formControl: this.lubricantNameCtrl },
    ...
    LubricantUseComponent.prototype.addNewRow = function () {
        ...
        this.newlyAddedList.push({
            lubricantName: '', amountConsumed: 0, reference: '', fractionOxidised: 0, carbonContent: 0
        });
        this.newDataSource.data = this.newlyAddedList;
    };
    ...
    LubricantUseComponent = LubricantUseComponent_1 = __decorate([
        core_1.Component({
