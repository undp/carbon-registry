...
@Component({
  selector: 'app-ghg-glass',
  templateUrl: './ghg-glass.component.html',
  styleUrls: ['./ghg-glass.component.scss']
})
export class GhgGlassComponent implements OnInit {
  ...
  private setDataTableConfig() {
    this.columnNameConfig = [
      {
        id: "glassProduced",
        value: "Amount of Glass produced (tonnes)",
        type: "number",
        placeHolder: "",
      },
      {
        id: "avgAnnualRatio",
        value: "Average Annual Cullet Ratio(%)",
        type: "number",
        placeHolder: "",
      },
      {
    ...
    this.dataTableTitle = "Glass Data";
  }
  ...
  initDataList() {
    this.glassData = [];
    this.glassData.push(this.newRec);
  }
  resetData() {
