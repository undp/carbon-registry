...
@Component({
  selector: 'app-ghg-soda-ash',
  templateUrl: './ghg-soda-ash.component.html',
  styleUrls: ['./ghg-soda-ash.component.scss']
})
export class GhgSodaAshComponent implements OnInit {
  ...
  private setDataTableConfig() {
    this.columnNameConfig = [
      {
        id: "sodaAshProduced",
        value: "Amount of Natural Soda Ash Produced (tonnes)",
        type: "number",
        placeHolder: "",
      },
      {
    ...
    this.dataTableTitle = "Soda Ash Data";
  }
  ...
  setFormValue(data: any) {
    ...
    this.dataList = data.sodaAshData;
  }
