...
@Component({
  selector: 'app-fugitive-oil',
  templateUrl: './fugitive-oil.component.html',
  styleUrls: ['./fugitive-oil.component.scss']
})
export class FugitiveOilComponent implements OnInit {
  ...
  private setDataTableConfig() {
    ...
    this.dataTableTitle = "Oil Fugutive Emission Data";
  }
  ...
  initDataList() {
    this.dataList = [];
    this.appService.getAppData({"key": "fugitiveOil"})
      .subscribe(response=> {  
  ...
  setFormValue(data: any) {
    ...
    this.dataList = data.fugitiveOilData;
  }
