...
var LimeProductionComponent = /** @class */ (function () {
    function LimeProductionComponent(_fb, _lps, _activatedRoute, _snackBar, router, appService) {
        this._fb = _fb;
        this._lps = _lps;
    ...
    LimeProductionComponent = LimeProductionComponent_1 = __decorate([
        core_1.Component({
