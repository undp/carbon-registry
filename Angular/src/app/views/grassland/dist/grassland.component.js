...
exports.GrasslandComponent = void 0;
var collections_1 = require("@angular/cdk/collections");
var core_1 = require("@angular/core");
var forms_1 = require("@angular/forms");
var material_1 = require("@angular/material");
var snackbar_dialog_component_1 = require("../modal/snackbar-dialog/snackbar-dialog.component");
var GrasslandComponent = /** @class */ (function () {
    function GrasslandComponent(_fb, _activatedRoute, _snackBar, router, appService) {
        this._fb = _fb;
        ...
        this.dataList = [
            { forestCategory: 'Forest Land converted to Grassland', area: 0, ghgEmissions: 0, reference: '' },
            { forestCategory: 'Cropland converted to Grassland', area: 0, ghgEmissions: 0, reference: '' },
            { forestCategory: 'Wetlands converted to Grassland', area: 0, ghgEmissions: 0, reference: '' },
            { forestCategory: 'Settlements converted to Grassland', area: 0, ghgEmissions: 0, reference: '' },
            { forestCategory: 'Other Land converted to Grassland', area: 0, ghgEmissions: 0, reference: '' }
        ];
        this.newlyAddedList = [];
        ...
        this.formGroup = this._fb.group({
            ...
            subSector: ['3.B.3-Grassland', [forms_1.Validators.required]],
            category: ['3.B-Land', [forms_1.Validators.required]],
            calculationApproach: ['Tier I', [forms_1.Validators.required]]
        });
    }
    GrasslandComponent_1 = GrasslandComponent;
    Object.defineProperty(GrasslandComponent.prototype, "matSort", {
        set: function (ms) {
            this.sort = ms;
    ...
    Object.defineProperty(GrasslandComponent.prototype, "matPaginator", {
        set: function (mp) {
            this.paginator = mp;
            this.setDataSourceAttributes();
        },
    ...
    GrasslandComponent.prototype.loadActivityData = function (type, value) {
        var _a;
        var _this = this;
        var obj = (_a = {
                menuId: GrasslandComponent_1.Constants.MENU_ID
            },
            _a[type] = value,
            _a);
        // this.dataList = [];
        ...
        if (obj) {
            this.appService.getDataRecord(obj).subscribe(function (res) {
                ...
                if (res.statusCode === 200 && res.data) {
                    ...
                    var d = res.data.grasslandData;
                    _this.dataList.forEach(function (data) {
                        res.data.grasslandData.forEach(function (element) {
    ...
    GrasslandComponent.prototype.getPermissionMenuId = function () {
        var _this = this;
        this.appService.getRecord(GrasslandComponent_1.Constants.MENU_ID).subscribe(function (res) {
            if (res.data) {
                _this.menu = res.data;
            }
        }, function (err) {
    ...
    GrasslandComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.yearList = [];
        this.getYears();
    ...
    GrasslandComponent.prototype.getYears = function () {
        var _this = this;
    ...
    GrasslandComponent.prototype.isInvalid = function (form, field, errorValue) {
    ...
    GrasslandComponent.prototype.setDataSourceAttributes = function () {
        this.dataSource.paginator = this.paginator;
        this.dataSource.sort = this.sort;
    };
    GrasslandComponent.prototype.ngAfterViewInit = function () {
        this.dataSource.paginator = this.paginator;
    };
    GrasslandComponent.prototype.applyFilter = function (filterValue) {
        var filter = {
    ...
    GrasslandComponent.prototype.customFilterPredicate = function () {
    ...
    GrasslandComponent.prototype.isAllSelected = function () {
        var numSelected = this.selection.selected.length;
        var numRows = this.dataSource.data.length;
        return numSelected === numRows;
    };
    GrasslandComponent.prototype.isAllNewSelected = function () {
        var numSelected = this.newSelection.selected.length;
        var numRows = this.newDataSource.data.length;
        return numSelected === numRows;
    };
    /** Selects all rows if they are not all selected; otherwise clear selection. */
    GrasslandComponent.prototype.masterToggle = function () {
        var _this = this;
        this.isAllSelected() ?
            this.selection.clear() :
            this.dataSource.data.forEach(function (row) { return _this.selection.select(row); });
    };
    GrasslandComponent.prototype.masterToggleNew = function () {
        var _this = this;
    ...
    GrasslandComponent.prototype.checkboxLabel = function (row) {
        if (!row) {
            return (this.isAllSelected() ? 'select' : 'deselect') + " all";
        }
        return (this.selection.isSelected(row) ? 'deselect' : 'select') + " row " + (row.position + 1);
    };
    GrasslandComponent.prototype.checkboxLabelNew = function (row) {
        if (!row) {
    ...
    GrasslandComponent.prototype.addNewRow = function () {
    ...
    GrasslandComponent.prototype.removeIndividuallyFromList = function (list, ele) {
        if (list === 'exist') {
    ...
    GrasslandComponent.prototype.removeSelected = function (list) {
        if (list === 'exist') {
    ...
    GrasslandComponent.prototype.openSnackBar = function (message, type) {
    ...
    GrasslandComponent.prototype.saveElectricityGeneration = function () {
        var _this = this;
        var obj = {
    ...
    GrasslandComponent.prototype.updateDataStaus = function (status) {
        var _this = this;
        var obj = {
            status: status,
    ...
    var GrasslandComponent_1;
    GrasslandComponent.Constants = {
        MENU_ID: 'GHG_AFOLU_Land_Grassland'
    };
    __decorate([
        core_1.ViewChild(material_1.MatSort, { static: false })
    ], GrasslandComponent.prototype, "matSort");
    __decorate([
        core_1.ViewChild(material_1.MatPaginator, { static: false })
    ], GrasslandComponent.prototype, "matPaginator");
    GrasslandComponent = GrasslandComponent_1 = __decorate([
        core_1.Component({
            selector: 'app-grassland',
            templateUrl: './grassland.component.html',
            styleUrls: ['./grassland.component.scss']
        })
    ], GrasslandComponent);
    return GrasslandComponent;
}());
exports.GrasslandComponent = GrasslandComponent;
