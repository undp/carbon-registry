...
var CementProductionComponent =
/** @class */
function () {
  function CementProductionComponent(_fb, _ts, _activatedRoute, _snackBar, _router, appService) {
    this._fb = _fb;
    this._ts = _ts;
    ...
    this.columnNames = [{
      id: "cementType",
      value: "Cement Type",
      formControl: this.cementTypeCtrl
    }, {
      id: "amountProduced",
      value: "Amount of Cement produced",
      formControl: this.amountProducedCtrl
    }, {
      id: "clinkerFraction",
      value: "Clinker Fraction in Cement(%)",
      formControl: this.clinkerFractionCtrl
    }, {
      id: "reference",
      value: "Reference",
  ...
  CementProductionComponent.prototype.updateDataStaus = function (status) {
    ...
    this._ts.updateDataStatus(obj).subscribe(function (res) {
      if (res.statusCode == 200) {
        ...
        _this._router.navigate(['ghg/ippu/Mineral_Industry/Cement_Production']);
      } else {
        _this.openSnackBar(res.message, 'error');
      }
    }, function (err) {
  ...
  CementProductionComponent = CementProductionComponent_1 = __decorate([core_1.Component({
