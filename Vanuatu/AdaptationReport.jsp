...
<%@page import="com.vanuatu.model.adaptation.AdaptationOutputCount"%>
...
<head>
	...
	<title>Adaptation Tracking Report</title>
	<!-- Global stylesheets -->
...
<div class="card border-teal">
	<div class="card-header bg-info-700">
		<h5 class="card-title text-center">Adaptation Tracking Report <%-- (${ghgReportOptions.getYear()}) --%></h5>
	</div>
	<div class="card-body">
	  			<div class="card">
	  			    <div class="card-body">
				<div class="form-group row">
					<div class="col-lg-12">
					<div class="row">
					<label class="col-lg-2 col-form-label text-left font-size-lg"><b>Select Category</b>&nbsp<span class="text-danger">*</span></label>
						<div class="col-md-6">
