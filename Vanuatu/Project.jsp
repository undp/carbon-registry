...
<div class="card-body font-size-lg">
    ...
    <label class="col-lg-2 col-form-label text-right">Cause&nbsp<span class="text-danger">*</span></label>
    <div class="col-lg-3">
   ...
   <div class="form-group row">
    <label class="col-lg-2 col-form-label text-right">Area&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
     <select name="area" required id ="areaId" class="form-control select" data-placeholder="--Select--" data-focu>
	  ...
	  <option value="Concrete Adaptation">Concrete Adaptation</option>
	  <option value="Concrete Mitigation">Concrete Mitigation</option>
...
<label class="col-lg-2 col-form-label text-right">Lifetime (years)</label>
 ...
 <input name="lifetime" id="lifetime" class="form-control input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true" placeholder="" value = "${project.lifetime}">
  ...
  <label class="col-lg-2 col-form-label text-right">Expected Commissioning Date&nbsp<span class="text-danger">*</span></label>
 <div class="col-lg-3">
...
<input class="form-control" required type="date" name="closureDate" id="id-date-picker-1" value = "${project.closureDate}">
   ...
   <select name="napa" id ="napa" class="form-control select" data-placeholder="--Select--" data-focu>
     ...
     <option value="NAP">NAP</option>
	  ...
	  <option value="NAMA">None</option>
	  </select>
   </div>
    <label class="col-lg-2 col-form-label text-right">Included in NDC&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
   <select name="ndc" id ="ndc" required class="form-control select" data-placeholder="--Select--" data-focu>
     <option></option>
