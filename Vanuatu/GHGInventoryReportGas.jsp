	  			...
	  			<div class="card">
	  			    <div class="card-body">
							...
							<div class="row">
								<div class="col-md-4">
									<fieldset>
										<legend class="font-weight-semibold text-center">Select Inventory Year&nbsp<span class="text-danger">*</span></legend>
						...
						<div class="form-group row">
							...
							<option value="${listValue}">${listValue}</option>
								...
								<fieldset>
					                	<legend class="font-weight-semibold text-center">Select Inventory Unit&nbsp<span class="text-danger">*</span></legend>
								...
								<div class="col-md-2">
								<br><br>
								<button class="btn btn-sm bg-info-700" style="margin-top:12px;">Get Report</button>
							</div>
							</div>
					</div></div>
