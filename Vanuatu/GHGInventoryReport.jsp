<%@page import="com.vanuatu.model.common.GHGReportOptions"%>
	  			...
	  			<div class="card">
	  			    <div class="card-body">
							...
							<div class="row">
								<div class="col-md-4">
									<fieldset>
										<legend class="font-weight-semibold text-center">Select Inventory Years&nbsp<span class="text-danger">*</span></legend>
