<%@page import="com.vanuatu.model.adaptation.*"%>
...
<div class="form-group row">
  ...
  <br>
  <div class="form-group row">
    <label class="col-lg-3 col-form-label text-center">NDP Objective Coverage&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-6">
  <select class="form-control select" required data-placeholder="--Select--" name="adaptationInfo.ndpObjCov" id ="ndpObjCov" data-focu>
  <option></option>
  ...
  <div class="form-group row">
  <label class="col-lg-3 col-form-label text-center">NDP Coverage&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-6">
...
<div class="tab-pane" id="forestry" role="tabpanel">
					<div class="card-group-control card-group-control-left">
						...
						<div class="card-header bg-info-700 ">
							...
							<div class="card-body">
									<h6 class="card-title">
										<a data-toggle="collapse" class="collapsed text-default font-weight-bold" href="#collapseForQl">Qualitative Impact</a>
									</h6>
...
<div class="card-group-control card-group-control-left">
						...
						<div class="card-header bg-info-700 ">
							...
							<div class="card-body">
									<h6 class="card-title">
										<a data-toggle="collapse" class="collapsed text-default font-weight-bold" href="#collapseRiskQl">Qualitative Impact</a>
									</h6>
...
<hr>
		...
		<div class="col-sm-12">
		<textarea class="form-control" id="remarks" name="foodNutrition.remarks">${existingAdaptationInput.getFoodNutrition().getRemarks()}</textarea>
		     </div>
			</div>
