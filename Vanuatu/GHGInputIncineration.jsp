					...
					<div class="table-responsive">
						<table id="openBurning" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"><fmt:formatNumber type="number" minFractionDigits="6" value="${existingGHGInputIncineration.getGhgInputWasteBurningList()[0].getFossilFraction()}" /></td>
