...
<div class="card-body font-size-lg">
    ...
    <div class="col-lg-6">
     ...
     <div class="form-group row">
   <label class="col-lg-2 col-form-label text-right">Monitoring Year&nbsp<span class="text-danger">*</span></label>
    <div class="col-lg-3">
  ...
  <input class="form-control" readonly="readonly" type="date" name="project.commissioningDate" id="id-date-picker-1" value = "${project.commissioningDate}">
   ...
   <div class="card-body">  
    <h6 class="card-title text-uppercase text-teal-600">Disbursement Details</h6>
	...
	<h7 class="card-title text-uppercase text-teal-600">Add Row</h7>				
	<div class="form-group row">			
