...
<br>
    ...
    <div class="card-body">
   <div class="form-group row">
   <label class="col-lg-2 col-form-label text-right">Financial Year&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
   ...
   <label class="col-lg-2 col-form-label text-right">Applied Exchange Rate (VT/USD)&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
   ...
   <div class="form-group row">
   <label class="col-lg-2 col-form-label text-right">Financing Mode&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
   ...
   <label class="col-lg-2 col-form-label text-right">Budget Code&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
  ...
  <input class="form-control" readonly="readonly" type="date" name="project.commissioningDate" id="id-date-picker-1" value = "${existingFinanceInput.project.commissioningDate}">
   ...
   <span class="text-danger">* Mandatory Field</span></div>
   ...
   <div class="form-group row">
   <label class="col-lg-2 col-form-label text-right">Project Size (million USD)&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
    <select name="financeInput.projectSize" required id ="projectSize" class="form-control select" data-placeholder="--Select--" data-focu>
     <option></option>
   ...
   <div class="form-group row">
   <label class="col-lg-2 col-form-label text-right">National Budget (USD)&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
   ...
   <label class="col-lg-2 col-form-label text-right">Sub National Budget (USD)&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
   ...
   <div class="form-group row">
   <label class="col-lg-2 col-form-label text-right">Green Bonds (USD)&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
   ...
   <div class="card border-grey">
   <div class="card-body">
      <h6 class="card-title text-uppercase text-teal-700">Sources of Finance</h6>
  ...
  <select name="natInt" id ="natInt" class="form-control select" data-placeholder="--Select--" data-focu>
   ...
   <button type="button" class="btn btn-sm bg-info-700 add-row1">Add</button>
   ...
   </div><span class="text-danger">* Mandatory Field</span></div>
	...
	<div class="card border-grey">
   <div class="card-body">  
    <h6 class="card-title text-uppercase text-teal-700">Project Cost Breakdown</h6>
					<div class="table-responsive">
					...
					<h6 class="card-title text-uppercase text-teal-700">Add Category</h6>
						<div class="form-group row">
   <div class="col-lg-4 text-center">Disbursement Category
    <select name="disCat" id ="disCat" class="form-control select" data-placeholder="--Select--" data-focu>
     ...
     <option value="Incremental Operating Costs">Incremental Operating Costs</option>
   ...
   <button type="button" class="btn btn-sm bg-info-700 add-row2">Add</button>
	...
	<br>  
	 <div class="card border-grey">
   <div class="card-body">  
      <h6 class="card-title text-uppercase text-teal-700">Disbursement Schedule</h6>
					<div class="table-responsive">
						<table id="disTable" class="table table-bordered table-striped">
							...
							<td><input type="checkbox" name='record2'></td>
                        			...
                        			<div>
                        			<input type="button" class="btn btn-sm bg-info-700 delete-row3" value="Delete Row">
                                   </div><hr>
                 <h6 class="card-title text-uppercase text-teal-700">Add Year</h6>
                <div class="form-group row">
   ...
   <div class="col-lg-1">
   <br>
   <button type="button" class="btn btn-sm bg-info-700 add-row3">Add</button>
  </div></div>
						</div></div></div>
						</div></div>
