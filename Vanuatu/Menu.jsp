...
<body class="navbar-md-md-top">
	...
	<div class="fixed-top">
		...
		<!-- Main navbar -->
		<div class="navbar navbar-expand-md navbar-dark bg-info-700">
			<div class="navbar-nav" >
			<a href="" style="margin-left:20px; margin-right:180px; margin-top:2px">
...
<ul class="navbar-nav">
					<li class="nav-item" style="margin-left:150px; margin-top:10px">
						<h3><a href="#" class="text-white text-center text-uppercase">
							Vanuatu's Climate Action Impact Assessment MRV Tool</a></h3>
			...
			<div class="navbar-collapse collapse" id="navbar-second">
				...
				<ul class="navbar-nav ml-md-auto">
					<li class="nav-item">
						...
						<a href="javaScript:{openNewWindowUM();}" class="navbar-nav-link"><i class="icon-book mr-2"></i>
							User Manual
							
						</a>
						 <!-- <a href="#" class="navbar-nav-link"><i class="icon-book mr-2"></i>
							User Manual
				...
				<div class="card card-sidebar-mobile">
					...
					<% if(userinfo!=null && !userinfo.getRole().equals("Nodal Officer") && userinfo.getGhgPermissions()!=null) { %>
					  ...
					  <c:forEach var="permissionList" items="${userInfo.ghgPermissions}">
						...
						<li class="nav-item nav-item-submenu">
						<a href="#" class="nav-link text-uppercase"><i class="fas fa-cloud mr-3 fa-1x"></i> <span>Projects</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Projects">
								<li class="nav-item"><a href="createProject" class="nav-link">Create New Project</a></li>
								<li class="nav-item"><a href="getProjectList" class="nav-link">Search Existing Projects</a></li>
							</ul>
						</li>
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="fas fa-globe mr-3 fa-1x"></i><span>SDGs ASSESSMENTS</span></a>
...
<script> 
function openNewWindowUM()
{
    window.open("global_assets/User Manual-Vanuatu_Integrated MRV Tool (Version 1.0) - August_2021.pdf")
    }
