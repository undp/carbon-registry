	...
	<div class="card border-teal">
					<div class="card-header bg-info-700">
						<h5 class="card-title text-uppercase text-center">Welcome</h5>
							...
							<a href="#" class="btn bg-info-700 dropdown-toggle" data-toggle="dropdown">Select Sector</a>
						...
						<c:if test="${permissionList=='Energy'}">
							...
							<div class="dropdown-menu">
							<a href="getGHGInputEnergy?subSector=1.A.1-Energy Industries&subCategory=1.A.1.a.i-Electricity Generation" class="dropdown-item">Electricity Generation</a>
							<a href="getGHGInputSolidFuel?subSector=1.A.1-Energy Industries&subCategory=1.A.1.c-Manufacture of Solid Fuels and Other Energy Industries" class="dropdown-item">Solid Fuels</a>
							<a href="getGHGInputEnergy?subSector=1.A.2-Manufacturing Industries and Construction&subCategory=" class="dropdown-item"> Manufacturing</a></li>
							<a href="getGHGInputEnergy?subSector=1.A.3-Transport&subCategory=" class="dropdown-item"> Transport</a>
							<a href="getGHGInputEnergy?subSector=1.A.4-Other Sectors&subCategory=" class="dropdown-item"> Others</a>
							...
							<div class="dropdown-menu">
							<div class="dropdown-submenu dropdown-submenu-right">
							<a href="#" class="dropdown-item dropdown-toggle">Non Energy Products and Solvent Use</a>
							<div class="dropdown-menu">
							...
							<div class="dropdown-submenu dropdown-submenu-right">
							<a href="#" class="dropdown-item dropdown-toggle">Ozone Depleting Substances</a>
							<div class="dropdown-menu">
							...
							<div class="card card-body text-center">
							<div class="mb-1">
							<h5 class="font-weight-semibold mb-0 mt-1">Projects</h5>
							</div>
							<a href="#" class="d-inline-block mb-1"><img src="global_assets/images/Tabs/Project1.png" class="" width="40" height="40" alt=""></a>
							<div class="btn-group justify-content-center">
							<a href="#" class="btn bg-info-700 dropdown-toggle" data-toggle="dropdown">Projects</a>
							...
							<div class="dropdown-menu">
							<a href="createProject" class="dropdown-item">Create New Project</a>
							<a href="getProjectList" class="dropdown-item">Search Existing Projects</a>
							</div>
							<% } %>
							</div></div>
							...
							<div class="btn-group justify-content-center">
							<a href="#" class="btn bg-info-700 dropdown-toggle" data-toggle="dropdown">Mitigation Information</a>
							...
							<a href="searchProjects?module=mitigationMonitoring" class="dropdown-item">Monitoring Information</a>
							</div><% } %></div></div>
							...
							<div class="btn-group justify-content-center">
							<a href="#" class="btn bg-info-700 dropdown-toggle" data-toggle="dropdown">Adaptation Information</a>
							...
							<a href="searchProjects?module=adaptation" class="dropdown-item">Project Information</a>
							<a href="searchProjects?module=adaptationMonitoring" class="dropdown-item">Monitoring Information</a>
							...
							<div class="btn-group justify-content-center">
							<a href="#" class="btn bg-info-700 dropdown-toggle" data-toggle="dropdown">Finance Information</a>
							...
							<a href="searchProjects?module=financeInput" class="dropdown-item">Project Information</a>
							<a href="searchProjects?module=financeMonitoring" class="dropdown-item">Monitoring Information</a>
							</div><% } %></div></div>
							
							<div class="card card-body text-center">
							<div class="mb-1">
							<h5 class="font-weight-semibold mb-0 mt-1">SDGs Assessments</h5>
							</div>
							<a href="#" class="d-inline-block mb-1"><img src="global_assets/images/Tabs/SDG1.png" class="" width="34" height="34" alt=""></a>
							<div class="btn-group justify-content-center">
							<a href="#" class="btn bg-info-700 dropdown-toggle" data-toggle="dropdown">SDG Information</a>
							...
							<a href="searchProjects?module=sdg" class="dropdown-item">Project Information</a>
							<a href="searchProjects?module=sdgMonitoring" class="dropdown-item">Monitoring Information</a>
							</div><% } %></div></div>
							...
							<div class="btn-group justify-content-center">
							<a href="#" class="btn bg-info-700 dropdown-toggle" data-toggle="dropdown">Select Database</a>
							...
							<a href="#" class="dropdown-item dropdown-toggle">Energy</a>
							<div class="dropdown-menu">
							<a href="getGHGFuelMapping" class="dropdown-item">Emission Factor - Fuel</a>
							</div></div>
							<div class="dropdown-submenu dropdown-submenu-right">
							<a href="#" class="dropdown-item dropdown-toggle">IPPU</a>
							<div class="dropdown-menu">
							<a href="getGHGGWP" class="dropdown-item">GWP Database</a>
							</div></div>
							<div class="dropdown-submenu dropdown-submenu-right">
							<a href="#" class="dropdown-item dropdown-toggle">AFOLU</a>
							<div class="dropdown-menu">
							<a href="getLivestockPopulation" class="dropdown-item">Livestock Population</a>
							<a href="getLivestockDatabase" class="dropdown-item">Emission Factor - Livestock</a>
							</div></div>
							<div class="dropdown-submenu dropdown-submenu-right">
							<a href="#" class="dropdown-item dropdown-toggle">Waste</a>
							<div class="dropdown-menu">
							<a href="getGHGPopulation?year=" class="dropdown-item">Population</a>
							</div></div>
							</div><% } %></div></div>
							...
							<div class="btn-group justify-content-center">
							<a href="#" class="btn bg-info-700 dropdown-toggle" data-toggle="dropdown">Select Report</a>
