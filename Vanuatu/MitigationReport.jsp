 ...
 google.charts.load('current', {packages:['corechart']});
  ...
  function drawChart() {
	  var data = google.visualization.arrayToDataTable([
          ...
          ["<%=selectedYear%>", <%=mitigationOutput.getMitigationInputGHG()%>, <%=mitigationOutput.getMitigationMonitoringGHG()%>],
                    
          ["Till Date", <%=mitigationOutput.getMitigationInputAllYearGHG()%>, <%=mitigationOutput.getMitigationMonitoringGHGAllYears()%>],
