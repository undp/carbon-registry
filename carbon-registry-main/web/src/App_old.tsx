...
import IdeaNoteManagement from './Pages/IdeaNoteManagement/IdeaNoteManagement';
import IdeaNoteDetail from './Pages/IdeaNoteDetail/IdeaNoteDetail';
            ...
            <BrowserRouter>
              <Routes>
                ...
                <Route path="/" element={<PrivateRoute />}>
                  ...
                  <Route
                    path="/IdeaNoteManagement"
                    element={<CustomLayout selectedKey="IdeaNoteManagement/viewAll" />}
                  >
                    <Route path="viewAll" element={<IdeaNoteManagement />} />
                  </Route>
                  <Route
                  ...
                  <Route
                    ...
                    element={<CustomLayout selectedKey="IdeaNoteManagement/viewAll" />}
                  >
                    <Route path="view" element={<IdeaNoteDetail />} />
                  </Route>
                  {/* <Route
                      path="/userManagement"
