...
DROP VIEW IF EXISTS public.programme_query_entity;
ALTER TABLE public.programme ALTER COLUMN "txType" TYPE "public"."programme_txtype_enum" USING "txType"::text::"public"."programme_txtype_enum";
...
CREATE OR REPLACE VIEW public.programme_query_entity
 ...
 SELECT programme."programmeId",
    ...
    programme."startTime",
    programme."article6_8_trade",
    programme."article6_4_trade",
    programme."article6_2_trade",
    programme."article6_MVC_ajuste_trade",
    programme."article6_MVC_non_ajuste_trade",
    programme."polygoneProjet",
    programme."endTime",
    programme."creditEst",
    ...
    programme."txRef",
    programme."txType"::programme_txtype_enum,
 ...
 DROP VIEW IF EXISTS public.programme_transfer_view_entity;
