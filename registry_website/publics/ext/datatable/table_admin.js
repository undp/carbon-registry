...
var KTUsersListr2 = function () {
    // Define shared variables
    var table = document.getElementById('kt_table_utilisateur');
    var datatable;
    var toolbarBase;
    var toolbarSelected;
    var selectedCount;
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                let id_catdelete = parent.querySelectorAll('td')[3].querySelectorAll('div')[0].querySelectorAll('div')[0].querySelectorAll('a')[0].getAttribute('data-bs-id');

                // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
                Swal.fire({
                    text: "Etes vous sur de vouloir supprimer ' " + userName + "'",
                    icon: "warning",
