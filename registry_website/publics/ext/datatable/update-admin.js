...
// Class definition
var KTModalExportUserad2 = function () {
    // Shared variables
    const element = document.getElementById('kt_modal2_update_usersa');
    const form = element.querySelector('#kt_modal2_update_usersa_form');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        $('.filetype2:checked').each(function() {
