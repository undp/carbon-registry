...
var KTUsersList2 = function () {
    ...
    var table = document.getElementById('kt_table_users2');
    var datatable;
    var toolbarBase;
    var toolbarSelected;
    var selectedCount;
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    text: "Etes vous sur de vouloir supprimer ' " + userName + "', notez que tous les fichiers associés seront aussi supprimés ?",
                    icon: "warning",
