    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                let id_catdelete = parent.querySelectorAll('td')[3].querySelectorAll('div')[0].querySelectorAll('div')[1].querySelectorAll('a')[0].getAttribute('data-bs-id');
                // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
                Swal.fire({
                    text: "êtes vous sur de vouloir supprimer : '" + userName + "'?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        ...
                        Swal.fire({
                            text: userName+ " n'a pas pu être supprimé",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "Ok, compris!",
                            customClass: {
