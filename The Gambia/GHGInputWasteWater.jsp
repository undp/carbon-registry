<%@page import="com.gambia.model.ghg.waste.GHGInputWasteWater"%>
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="remarks" placeholder="${ghgInputWasteWater[0].getRemarks()}"></textarea>
     </div>
</div>
