<%@page import="com.gambia.model.ghg.afolu.land.GHGInputWetland"%>
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="remarks" placeholder="${existingGHGInputWetland[0].getRemarks()}"></textarea>
     </div>
</div>
