...
<div class="card-body">
    <div class="table-responsive">
    					...
    					<thead>
                           ...
                           <tbody>
                           <c:forEach var="output" varStatus="loop" items="${ghgInputBiomassBurningList}">
									<tr>
                   ...
                   <button type="button" class="btn btn-sm bg-slate-700" data-toggle="modal" data-target="#modal_form_vertical">Add Row</button>
                   </div></div>   

<div class="form-group">
<span class="col-sm-3 control-label">Remarks</span>
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="remarks" placeholder="${ghgInputBiomassBurningList[0].getRemarks()}"></textarea>
</div>
</div>
...
<option value="Other Lands">Other Lands</option>
   ...
   <div class="col-lg-1">
   <br>
   <button type="button" class="btn btn-sm bg-slate-700 add-row1">Add</button></div></div>
