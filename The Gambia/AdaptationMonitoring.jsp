<%@page import="com.gambia.model.adaptation.AdaptationMonitoring"%>
...
<div class="col-lg-6">
<select name="projectId" id="projectId"  data-placeholder="--Select--"  onchange="getData(this.value);" class="form-control form-control-select2" data-focu>
<option></option>
...
<div class="form-group row">
   <label class="col-lg-3 col-form-label text-right">Year</label>
    <div class="col-lg-3">
  	<select name="year" required data-placeholder="--Select--" onchange="getData(this.value);" required class="form-control select" id="yearId"  data-fouc>
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="foodNutrition.remarks" placeholder="${existingAdaptationMonitoring.getFoodNutrition().getRemarks()}"></textarea>
     </div>
</div>
