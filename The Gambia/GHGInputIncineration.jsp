					...
					<div class="table-responsive">
						<table id="openBurning" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true">${existingGHGInputIncineration.getGhgInputWasteBurningList()[0].getFossilFraction()}</td>
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="remarks" placeholder="${existingGHGInputIncineration.getGhgInputIncinerationList()[0].getRemarks()}"></textarea>
     </div>
</div>
