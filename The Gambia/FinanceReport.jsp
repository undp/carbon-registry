 ...
 google.charts.load('current', {packages:['corechart']});
  ...
  function drawChart() {
	  var data = google.visualization.arrayToDataTable([
          ['Year', 'Actual Spend (USD)', 'Expected Spend (USD)'],
          
          ["<%=selectedYear%>", <%=financeOutput.getMonitoringDisbursement()%>, <%=financeOutput.getDisbursement()%>],
                    
          ["Till Date", <%=financeOutput.getMonitoringDisbursementAllYear()%>, <%=financeOutput.getDisbursementAllYear()%>],
