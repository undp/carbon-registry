<%@page import="com.gambia.model.ghg.waste.*"%>
...
<div class="form-group">
      				<div class="card">
                    <div class="card-body">
      				<h6 class="card-title">Solid Waste Data</h6>
					<div class="table-responsive">
						<table id="ghgTable1" class="table table-bordered table-striped">
                            ...
                            <tr class="bg-slate-700 text-center">
                                ...
                                <th>Fraction of waste going to SWDS</th>
                                <th>CH<sub>4</sub> Generation per ton of waste (kg/tonne)</th>
                                <th>Reference</th>
                                </tr>
                            </thead>
                            <tbody>
                        ...
                        <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', im-insert="true">${existingGHGInputSolidWaste.getWasteFraction()}</td>
                        <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal',  im-insert="true">${existingGHGInputSolidWaste.getCh4GenerationPerTon()}</td>
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="remarks" placeholder="${existingGHGInputSolidWaste.getRemarks()}"></textarea>
     </div>
</div>
...
function setValues(){
    ...
    for (i = 1; i < rowLength; i++){
       ...
       for(var j = 0; j < cellLength; j++){
           ...
           if(j==2){
        	   name = "ghgInputSolidList["+x+"].wasteFraction";
        	              }
           if(j==3){
        	   name = "ghgInputSolidList["+x+"].ch4GenerationPerTon";
        	              }
           if(j==4){
