...
<div class="card-body font-size-lg">
  ...
  <div class="form-group row">
   ...
   <div class="col-lg-3">
   <input name="ghgInput.calcApproach" readonly="readonly" id="subSector" class="form-control" value="Tier 1"> 
   </div>
  </div>
  <hr>            
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="remarks" placeholder="${existingGHGInputEnergy[0].getRemarks()}"></textarea>
     </div>
</div></div>
