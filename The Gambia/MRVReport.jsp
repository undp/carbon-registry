<%@page import="com.gambia.model.common.MRVOutput"%>
...
<br>
   ...
   <div class="card border-grey">
    ...
    <h6 class="card-title text-uppercase text-slate-700">Mitigation Performance</h6>
	...
	<div class="card border-grey">
   <div class="card-body">  
    <h6 class="card-title text-uppercase text-slate-700">Adaptation Performance</h6>
    ...
    <table id="adaptationTable2" class="table table-bordered datatable-button-html5-basic" >
					...
					<br>  
					 <div class="card border-grey">
				   <div class="card-body">  
				      <h6 class="card-title text-uppercase text-slate-700">Climate Finance Summary</h6>
									<div class="table-responsive">
	...
	<div class="card border-grey">
   <div class="card-body">  
    <h6 class="card-title text-uppercase text-slate-700">SDG Performance</h6>
    <div class="table-responsive">
