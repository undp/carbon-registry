<%@page import="com.gambia.model.ghg.ippu.*"%>
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="remarks" placeholder="${existingGHGInputLubricant[0].getRemarks()}"></textarea>
     </div>
</div>
...
function setStatus(id){
	...
	<% if(existingGHGInputSolid!=null) { %>
	document.getElementById('dataId').value = "<%=existingGHGInputSolid.get(0).getDataId()%>";
