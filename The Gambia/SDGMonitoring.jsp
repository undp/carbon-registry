<%@page import="com.gambia.model.sdg.SDGMonitoring"%>
...
<div class="form-group row">
<label class="col-lg-4 col-form-label text-right">Monitoring Year</label>
<div class="col-lg-3">
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="poverty.remarks" placeholder="${sdgMonitoring.getPoverty().getRemarks()}"></textarea>
</div>
</div>
