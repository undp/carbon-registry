...
<br>
   ...
   <div class="col-lg-3">
   <input name="financeInput.financialYear"  id="financialYear" class="form-control" value="${existingFinanceInput.financeInput.financialYear}">
    </div>
   <label class="col-lg-2 col-form-label text-right">Applied Exchange Rate (UGX/USD)</label>
   <div class="col-lg-3">
   <input name="financeInput.exchangeRate"  id="exchangeRate" class="form-control input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true" value="${existingFinanceInput.financeInput.exchangeRate}">
   </div></div>
   
   <div class="form-group row">
   <label class="col-lg-2 col-form-label text-right">Financing Mode</label>
   <div class="col-lg-3">
    <select name="financeInput.financeMode"  id ="financeMode" class="form-control select" data-placeholder="--Select--" data-focu>
     <option></option>
   ...
   <div class="col-lg-3">
   <input name="financeInput.budgetCode"  id="budgetCode" class="form-control" placeholder="" value="${existingFinanceInput.financeInput.budgetCode}">
   </div>
   </div>
   ...
   <div class="col-lg-3">
  <input class="form-control" readonly="readonly" type="date" name="project.approvalDate" id="id-date-picker-1" value = "${existingFinanceInput.project.approvalDate}">
   </div>
  ...
  <input class="form-control" readonly="readonly" type="date" name="project.commissioningDate" id="id-date-picker-1" value = "${existingFinanceInput.project.commissioningDate}">
   ...
   <div class="form-group row">
   <label class="col-lg-2 col-form-label text-right">Project Size (million USD)</label>
   <div class="col-lg-3">
    <select name="financeInput.projectSize" id ="projectSize" class="form-control select" data-placeholder="--Select--" data-focu>
     <option></option>
   ...
   <div class="form-group row">
   <label class="col-lg-2 col-form-label text-right">National Budget (USD)</label>
   <div class="col-lg-3">
   <input name="financeInput.nationalBudget" id="nationalBudget" onchange = "subtractOthers();" class="form-control input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true" value="${existingFinanceInput.financeInput.nationalBudget}">
   </div>
   <label class="col-lg-2 col-form-label text-right">Sub National Budget (USD)</label>
   <div class="col-lg-3">
   <input name="financeInput.subnationalBudget" id="subnationalBudget" onchange = "subtractOthers();" class="form-control input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true" value="${existingFinanceInput.financeInput.subnationalBudget}">
   </div>
   </div>
   <div class="form-group row">
   <label class="col-lg-2 col-form-label text-right">Green Bonds (USD)</label>
   <div class="col-lg-3">
   <input name="financeInput.greenBond" id="greenBond" onchange = "subtractOthers();" class="form-control input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true" value="${existingFinanceInput.financeInput.greenBond}">
   </div>
   ...
   <div class="card border-grey">
   <div class="card-body">
      <h6 class="card-title text-uppercase text-slate-700">Sources of Finance</h6>
  ...
  <select name="natInt" id ="natInt" class="form-control select" data-placeholder="--Select--" data-focu>
   ...
   <button type="button" class="btn btn-sm bg-slate-700 add-row1">Add</button>
	...
	<div class="card border-grey">
   <div class="card-body">  
    <h6 class="card-title text-uppercase text-slate-700">Project Cost Breakdown</h6>
					<div class="table-responsive">
					...
					<h6 class="card-title text-uppercase text-slate-700">Add Category</h6>
						<div class="form-group row">
   ...
   <button type="button" class="btn btn-sm bg-slate-700 add-row2">Add</button>
	...
	<br>  
	 <div class="card border-grey">
   <div class="card-body">  
      <h6 class="card-title text-uppercase text-slate-700">Disbursement Schedule</h6>
					<div class="table-responsive">
						<table id="disTable" class="table table-bordered table-striped">
							...
							<td><input type="checkbox" name='record2'></td>
                        			...
                        			<div>
                        			<input type="button" class="btn btn-sm bg-slate-700 delete-row3" value="Delete Row">
                                   </div><hr>
                 <h6 class="card-title text-uppercase text-slate-700">Add Year</h6>
                <div class="form-group row">
   ...
   <div class="col-lg-1">
   <br>
   <button type="button" class="btn btn-sm bg-slate-700 add-row3">Add</button>
  </div></div>
						</div></div></div>
						</div></div>
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="financeInput.remarks" placeholder="${existingFinanceInput.getFinanceInput().getRemarks()}"></textarea>
     </div>
</div>
