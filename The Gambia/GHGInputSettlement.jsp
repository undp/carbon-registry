<%@page import="com.gambia.model.ghg.afolu.land.*"%>
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="remarks" placeholder="${existingGHGInputSettlement[0].getRemarks()}"></textarea>
     </div>
</div>
