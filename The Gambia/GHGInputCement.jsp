...
<div class="form-group">
   ...
   <button type="button" class="btn btn-sm bg-slate-700 add-row1">Add</button>
                        ...
                        <h4 class="card-title">Clinker Data</h4>
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="remarks" placeholder="${existingGHGInputCement.getGhgInputCementList()[0].getRemarks()}"></textarea>
     </div>
</div>
