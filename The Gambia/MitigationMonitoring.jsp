...
<div class="card-body font-size-lg">
    ...
    <div class="form-group row">
   <label class="col-lg-3 col-form-label text-right">Inventory Year</label>
    <div class="col-lg-3">
  ...
  <div class="form-group row">
   ...
   <div class="form-group row">
   <label class="col-lg-2 col-form-label text-right">Actual GHG Savings (tCO<sub>2</sub>e/ year)</label>
   <div class="col-lg-3">
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="mitigationMonitoring.remarks" placeholder="${existingMitigationMonitoring.getMitigationMonitoring().getRemarks()}"></textarea>
     </div>
</div>
