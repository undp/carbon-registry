...
@ViewEntity({
    expression: `
    SELECT programme_transfer.*, "requester"."logo" as "requester", "certifier"."logo" as "certifier", "prog"."creditBalance" as "creditBalance", "sender"."logo" as "senderLogo", "prog"."title" as "programmeTitle", "prog"."sector" as "programmeSector" FROM "programme_transfer" "programme_transfer" 
