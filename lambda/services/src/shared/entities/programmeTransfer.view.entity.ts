...
@ViewEntity({
    expression: `
    SELECT programme_transfer.*, "requester".* as "requester", "prog"."creditBalance" as creditBalance, "prog"."title" as "programmeTitle", "prog"."sector" as "programmeSector", JSON_AGG(distinct "certifier".*) as "certifier", JSON_AGG(distinct "sender".*) as "sender" 
...
export class ProgrammeTransferEntityView extends ProgrammeTransfer {
    @ViewColumn()
