...
export const ProgrammeRejectAndTransferComponent: FC<
  ProgrammeRejectAndTransferCardItemProps
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="total-programme-details">
            ...
            <div className="icon">
              <Clipboard2Pulse color="#008f39" size={80} />
            </div>
          </div>
          <div className="total-programme-extra-details">
            <div className="rejected-details margin-top-1">
              <div className="icon">
                <div className="icon-container authorized">
                  <HandThumbsUp color="#008f39" size={25} />
                </div>
              </div>
              <div className="details">
                <div className="label-and-value">
                  <div className="label">Autorisé</div>
                ...
                <div className="stastic-bar">
                  <Progress
                    ...
                    status="active"
                    strokeColor={{ from: "#B9E2F4", to: "#0dcc59" }}
                  />
                </div>
              </div>
            </div>
            <div className="transfered-details margin-top-1">
              ...
              <div className="details">
                <div className="label-and-value">
                  <div className="label">Rejeté</div>
          ...
          <div className="updated-on margin-top-6">
            {updatedDate !== "0" && (
              <div className="updated-moment-container">{updatedDate}</div>
            )}
          </div>
        </>
      )}
