                ...
                <Skeleton loading={false} active>
                  <Row justify="center">
                    <img
                      ...
                      alt="profile image"
                      src={IdeaNoteDetail[2]?.logo}
                    />
                  </Row>
                  <Row justify="center">
                    <div className="padding-top-1 company-name">
                      {IdeaNoteDetail[2]?.denomination}
                    </div>
                  </Row>
                  <Row justify="center">
                    <div className="padding-top-1 company-name">
                      {IdeaNoteDetail[2]?.site_web}
                    </div>
                  </Row>
                  <Row justify="center">
                    <div className="padding-top-1 company-name">
                      {IdeaNoteDetail[2]?.email_admin_organisation}
                    </div>
                  </Row>
                  <Row justify="center">
                    <div className="padding-top-1 company-name">
                      {IdeaNoteDetail[2]?.numero_tel_organisation}
                    </div>
                  </Row>
                </Skeleton>
              </Card>
