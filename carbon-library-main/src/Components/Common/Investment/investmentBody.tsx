...
export const InvestmentBody: FC<InvestmentBodyProps> = (
  props: InvestmentBodyProps
) => {
  ...
  return loading ? (
    ...
    <div className="investment-body">
      <div className="invester">
        ...
        <div className="time">
          {moment(parseInt(investmentData?.createdAt)).format(
            "DD MMMM YYYY @ HH:mm"
          )}
        </div>
      </div>
