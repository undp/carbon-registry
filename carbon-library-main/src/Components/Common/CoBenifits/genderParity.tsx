...
const GenderParity = (props: any) => {
  ...
  const [genderParityFormOneFields, setGenderParityFormOneFields] = useState<
    any[]
  >(genderParityDetailsOne);
  const [genderParityFormTwoFields, setGenderParityFormTwoFields] = useState<
    any[]
  >(genderParityDetailsTwo);
  ...
  return (
    <div className="co-benifits-tab-item">
      ...
      >
        {genderParityFormOneFields?.length === 0 &&
          genderParityFormTwoFields?.length === 0 && (
