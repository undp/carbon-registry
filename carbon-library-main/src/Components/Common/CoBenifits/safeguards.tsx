...
const Safeguards = (props: any) => {
  ...
  const [updatedFormElementList, setUpdatedFormElementList] = useState<any[]>(
    initialFormElementList
  );
                    ...
                    if (item.type === FormElementType.Radio) {
                      return (
                        <>
                          ...
                          {viewOnly &&
                            safeGuardViewData.hasOwnProperty(item?.name) && (
                      ...
                      return (
                        <>
                          {(item.isVisible || !viewOnly) && (
                            <div style={{ marginBottom: "15px" }}>
                              <label className="co-sub-title-text mg-left-2">
                                {item.label}
                              </label>
                            </div>
                          )}
                          {item.items.map((subItem: any) => {
                            return (
                              <>
                                ...
                                {viewOnly &&
                                  safeGuardViewData.hasOwnProperty(
                                    subItem?.name
                                  ) && (
                                    <div className="view-section">
                                      <Form.Item
