    ...
    <Card className="card-container">
      <div className="info-view">
        <div className="title">
          ...
          <span className="title-text">Note d'idée</span>
        </div>
        <Skeleton loading={false} active>
          ...
          <Row className="field">
            ...
            <Col span={12} className="field-value nextline-overflow">
              <a
                href={
                  IdeaNoteDetail[0]?.document_conformite
                    ? IdeaNoteDetail[0]?.document_conformite
                    : "-"
                }
                target="_blank"
          ...
          <Row className="field">
            ...
            <Col span={12} className="field-value nextline-overflow">
              {IdeaNoteDetail[0]?.date_creation
                ? IdeaNoteDetail[0]?.date_creation
                : "-"}
            </Col>
          </Row>
          ...
          {statusnoteidee === "recours" && (
            <Row className="field">
              <Col span={12} className="field-key">
                Commentaire de recours
              </Col>
              <Col span={12} className="field-value">
                {IdeaNoteDetail[0]?.Commentaire_recours
                  ? IdeaNoteDetail[0]?.Commentaire_recours
                  : "-"}
              </Col>
            </Row>
