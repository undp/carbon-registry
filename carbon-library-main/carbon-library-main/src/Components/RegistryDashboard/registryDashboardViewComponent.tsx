...
export const RegistryDashboardComponent = (props: any) => {
  ...
  const colors = ["#0dcc59", "#CDCDCD", "#FF8183", "#B7A4FE"];
        ...
        <Row gutter={[40, 40]} className="stastic-card-row">
          <Col xxl={8} xl={8} md={12} className="stastic-card-col">
            <StasticCard
              ...
              icon={
                userInfoState?.companyRole === CompanyRole.GOVERNMENT ? (
                  <ClockHistory color="#008f39" size={80} />
                ) : userInfoState?.companyRole ===
                  CompanyRole.PROGRAMME_DEVELOPER ? (
                  <BoxArrowInRight color="#008f39" size={80} />
                ) : (
                  <ShieldX color="#008f39" size={80} />
                )
              }
          ...
          <Col xxl={8} xl={8} md={12} className="stastic-card-col">
            <StasticCard
              ...
              icon={
                userInfoState?.companyRole === CompanyRole.GOVERNMENT ? (
                  <BoxArrowRight color="#008f39" size={80} />
                ) : userInfoState?.companyRole ===
                  CompanyRole.PROGRAMME_DEVELOPER ? (
                  <BoxArrowRight color="#008f39" size={80} />
                ) : (
                  <ShieldCheck color="#008f39" size={80} />
                )
              }
              loading={loadingWithoutTimeRange}
              companyRole={userInfoState?.companyRole}
          ...
          <Col xxl={8} xl={8} md={12} className="stastic-card-col">
            <StasticCard
              ...
              icon={
                userInfoState?.companyRole === CompanyRole.GOVERNMENT ? (
                  <Gem color="#008f39" size={80} />
                ) : userInfoState?.companyRole ===
                  CompanyRole.PROGRAMME_DEVELOPER ? (
                  <Gem color="#008f39" size={80} />
                ) : (
                  <ShieldExclamation color="#008f39" size={80} />
                )
              }
              loading={loadingWithoutTimeRange}
              companyRole={userInfoState?.companyRole}
                ...
                {loadingCharts ? (
                  ...
                  <>
                    ...
                    <div className="stage-legends">
                      <LegendItem text="Autorisé" color="#0dcc59" />
                      {!(
                        userInfoState?.companyRole === CompanyRole.CERTIFIER &&
                        categoryType === "mine"
                      ) && (
                        <>
                          <LegendItem text="Rejeté" color="#CDCDCD" />
                          <LegendItem text="En attente" color="#FF8183" />
                          <LegendItem text="Approuvé" color="#B7A4FE" />
                        </>
                      )}
                    </div>
