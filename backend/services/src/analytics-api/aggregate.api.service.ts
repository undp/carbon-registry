...
import { StatusGroupedByTimedata, StatusGroupedByTimedataThere } from "../dto/programmeStatus.timeGrouped.result";
...
import { EmissionSubSectorsPathMap, EmissionSubSectorsToSectoralScopeMap } from "src/enum/sectoral.scope.enum";
