...
<div class="card border-pink">
	<div class="card-header bg-pink-600">
		<h5 class="card-title text-center">GHG Inventory ${ghgReportOptions.getFromYear()} (${ghgReportOptions.getUnit()}) </h5>
	</div>
	  			    ...
	  			    <div class="card-body">
						...
						<div class="form-group row">
							...
							<option value="${listValue}">${listValue}</option>
								...
								<div class="col-md-2">
								<br><br>
								<button class="btn btn-sm bg-pink-600" style="margin-top:12px;">Get Report</button>
							</div>
							</div>
					</div></div>
...
<div class="form-group">
					<div id = "energy">
      				<div class="card">
      				<div class="card-header header-elements-inline">
						<h6 class="card-title">GHG Inventory (${ghgReportOptions.getUnit()})</h6>
						<div class="header-elements">
							<div class="list-icons">
		                		<a class="list-icons-item" data-action="collapse"></a>
		                	</div>
                    ...
                    <div class="table-responsive">
						<table id="data-table" class="table table-bordered datatable-button-html5-basic">
                            ...
                            <tr class="bg-pink-600 text-center">
                                <th>${ghgReportOptions.getFromYear()}</th>
                                <th>CO<sub>2</sub> Emissions</th>
                                <th>CH<sub>4</sub> Emissions</th>
                                <th>N<sub>2</sub>O Emissions</th>
								<th>Total GHG Emissions (${ghgReportOptions.getUnit()})</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach var="entry" items="${ghgOutputMap}">
                            <tr class="font-size-lg text-center">
								<td><a data-toggle="collapse" class="text-default" href="#collapsible-item-nested-parent${entry.key}"><b>Total Emissions *</b></a></td>
                            ...
                            <tr class="font-size-lg font-size-bold collapse" id="collapsible-item-nested-parent${entry.key}">
							...
							<tr class="font-size-sm collapse" id="collapsible-item-nested-parent${entry.key}">
								...
								<tr class="collapse" id="collapsible-item-nested-parent${entry.key}">
								<td class="text-center"><b>1.B-Fugitive emissions from fuels</b></td>
								<td>${entry.value.getFugitive().get("1.B-Fugitive emissions from fuels").getCo2Emission()}</td>
								<td>${entry.value.getFugitive().get("1.B-Fugitive emissions from fuels").getCh4Emission()}</td>
								<td>${entry.value.getFugitive().get("1.B-Fugitive emissions from fuels").getN2oEmission()}</td>
								<td>${entry.value.getFugitive().get("1.B-Fugitive emissions from fuels").getTotalEmission()}</td>
								</tr>
								<tr class="font-size-sm collapse" id="collapsible-item-nested-parent${entry.key}">
								<td class="text-right">1.B.2-Oil and Natural Gas</td>
								<td>${entry.value.getFugitiveOilGas().get("1.B.2-Oil and Natural Gas").getCo2Emission()}</td>
								<td>${entry.value.getFugitiveOilGas().get("1.B.2-Oil and Natural Gas").getCh4Emission()}</td>
								<td>${entry.value.getFugitiveOilGas().get("1.B.2-Oil and Natural Gas").getN2oEmission()}</td>
								<td>${entry.value.getFugitiveOilGas().get("1.B.2-Oil and Natural Gas").getTotalEmission()}</td>
							</tr>
							...
							<tr class="font-size-sm collapse" id="collapsible-item-nested-parent${entry.key}">
								<td class="text-right">3.C.2-Liming</td>
								<td>${entry.value.getLiming().get("3.C.2-Liming").getCo2Emission()}</td>
								<td>${entry.value.getLiming().get("3.C.2-Liming").getCh4Emission()}</td>
								<td>${entry.value.getLiming().get("3.C.2-Liming").getN2oEmission()}</td>
								<td>${entry.value.getLiming().get("3.C.2-Liming").getTotalEmission()}</td>
							</tr>
							<tr class="font-size-sm collapse" id="collapsible-item-nested-parent${entry.key}">
								<td class="text-right">3.C.3-Urea Application</td>
								<td>${entry.value.getUrea().get("3.C.3-Urea Application").getCo2Emission()}</td>
								<td>${entry.value.getUrea().get("3.C.3-Urea Application").getCh4Emission()}</td>
								<td>${entry.value.getUrea().get("3.C.3-Urea Application").getN2oEmission()}</td>
								<td>${entry.value.getUrea().get("3.C.3-Urea Application").getTotalEmission()}</td>
							</tr>
							<tr class="font-size-sm collapse" id="collapsible-item-nested-parent${entry.key}">
								<td class="text-right">3.C.4-Direct N<sub>2</sub>O emissions from managed soils</td>
								<td>${entry.value.getDirectn2oManaged().get("3.C.4-Direct N2O emissions from managed soils").getCo2Emission()}</td>
								<td>${entry.value.getDirectn2oManaged().get("3.C.4-Direct N2O emissions from managed soils").getCh4Emission()}</td>
								<td>${entry.value.getDirectn2oManaged().get("3.C.4-Direct N2O emissions from managed soils").getN2oEmission()}</td>
								<td>${entry.value.getDirectn2oManaged().get("3.C.4-Direct N2O emissions from managed soils").getTotalEmission()}</td>
							</tr>
							<tr class="font-size-sm collapse" id="collapsible-item-nested-parent${entry.key}">
								<td class="text-right">3.C.5-Indirect N<sub>2</sub>O emissions from managed soils</td>
								<td>${entry.value.getIndirectn2oManaged().get("3.C.5-Indirect N2O emissions from managed soils").getCo2Emission()}</td>
								<td>${entry.value.getIndirectn2oManaged().get("3.C.5-Indirect N2O emissions from managed soils").getCh4Emission()}</td>
								<td>${entry.value.getIndirectn2oManaged().get("3.C.5-Indirect N2O emissions from managed soils").getN2oEmission()}</td>
								<td>${entry.value.getIndirectn2oManaged().get("3.C.5-Indirect N2O emissions from managed soils").getTotalEmission()}</td>
							</tr>
							<tr class="font-size-sm collapse" id="collapsible-item-nested-parent${entry.key}">
							...
							<tr class="collapse" id="collapsible-item-nested-parent${entry.key}">
								...
								<td>${entry.value.getWasteWater().get("4.D-Wastewaster Treatment and Discharge").getCo2Emission()}</td>
								<td>${entry.value.getWasteWater().get("4.D-Wastewaster Treatment and Discharge").getCh4Emission()}</td>
								<td>${entry.value.getWasteWater().get("4.D-Wastewaster Treatment and Discharge").getN2oEmission()}</td>
								<td>${entry.value.getWasteWater().get("4.D-Wastewaster Treatment and Discharge").getTotalEmission()}</td>
							</tr>
                           ...
                           <span class="text-pink">* click to expand</span>
                          	</div>  
  <hr></div></div></div>
