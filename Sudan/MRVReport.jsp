<%@page import="com.sudan.model.common.MRVOutput"%>
...
<br>
   ...
   <div class="card border-grey">
    ...
    <h6 class="card-title text-uppercase text-pink-600">Mitigation Performance</h6>
	...
	<div class="card border-grey">
   <div class="card-body">  
    <h6 class="card-title text-uppercase text-pink-600">Adaptation Performance</h6>
    ...
    <table id="adaptationTable2" class="table table-bordered datatable-button-html5-basic" >
							...
							<tr>
								<td class="bg-light">${output.adaptationCategoryMap.get(entry2.key)}</td>
										<td>${questionMap.key}</td>
										<td>${questionMap.value}</td>
										
										<c:forEach var="map" items="${output.actualAdapMap}" varStatus="loop">
												<c:choose>
												<c:when test = "${map.value.containsKey(questionMap.key)}">
					...
					<br>  
					 <div class="card border-grey">
				   <div class="card-body">  
				      <h6 class="card-title text-uppercase text-pink-600">Climate Finance Summary</h6>
									<div class="table-responsive">
	...
	<div class="card border-grey">
   <div class="card-body">  
    <h6 class="card-title text-uppercase text-pink-600">SDG Performance</h6>
    <div class="table-responsive">
						...
						<tr class="bg-pink-600">
							...
							<td class="bg-light">${output.sdgCategoryMap.get(entry2.key)}</td>    
									<td>${questionMap.key}</td>
									<td>${questionMap.value}</td>
