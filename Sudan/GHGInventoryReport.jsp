<%@page import="com.sudan.model.common.GHGReportOptions"%>
...
<div class="form-group">
   ...
   <table id="data-table" class="table table-bordered datatable-button-html5-basic">
	...
	<tr class="bg-pink-600">
		<th><b>GHG Emissions (${ghgReportOptions.getUnit()})</b></th>
...
<tbody>	
 <tr class="font-size-lg bg-pink-600 font-weight-bold">
		<td><b>Total GHG Emissions</b></td>
		<c:forEach var="entry" items="${ghgOutputMap}">
		<td>${entry.value.getTotal().get("Total").getTotalEmission()}</td>
		</c:forEach>
		</tr>
		<tr class="font-size-lg font-weight-bold">
			...
			<tr class="collapse" id="collapsible-item-nested-parent1">
			<td><b>1.B-Fugitive emissions from fuels</b></td>
			<c:forEach var="entry" items="${ghgOutputMap}">
			...
			<tr class="font-size-sm collapse" id="collapsible-item-nested-parent1">
			<td>1.B.2-Oil and Natural Gas</td>
			<c:forEach var="entry" items="${ghgOutputMap}">
			...
			<tr class="font-size-lg font-weight-bold">
			<td><a data-toggle="collapse" class="text-default" href="#collapsible-item-nested-parent2"><b>2-Industrial Processes and Product Use</b></a></td>
			<c:forEach var="entry" items="${ghgOutputMap}">
		...
		<tr class="font-size-lg font-weight-bold text-default">
