...
List<GHGInputGrassland> existingGHGInputGrassland = null;

if(request.getAttribute("existingGHGInputGrassland")!=null){
	existingGHGInputGrassland = (List<GHGInputGrassland>)request.getAttribute("existingGHGInputGrassland");
...
<div class="card border-pink">
	<div class="card-header bg-pink-600">
		<h5 class="card-title text-uppercase text-center">GHG Inventory - Grassland</h5>
	</div>

	<div class="card-body">
	<form action="saveGHGInputGrassland" method="post" onsubmit="return setValues();" class="form-horizontal bordered-row" id="ghgInputForm" data-parsley-validate="">
...
<div class="form-group">
      				<div class="card">
                    <div class="card-body">
      <h6 class="card-title">Grassland Data</h6>
					<div class="table-responsive">
						<table id="ghgTable1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <c:choose>
							<c:when test = "${empty existingGHGInputGrassland}">
                            <tr>
                                <td>Grassland Remaining Grassland </td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Forest Land converted to Grassland</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Cropland converted to Grassland</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Wetlands converted to Grassland</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Settlements converted to Grassland</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Other Land converted to Grassland</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
								<td contenteditable='true'></td>
                                </tr>
							...
							<c:forEach var="output" varStatus="loop" items="${existingGHGInputGrassland}">
							    <tr>
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="remarks">${existingGHGInputGrassland[0].getRemarks()}</textarea>
     </div>
</div>
...
function setValues(){
    ...
    for (i = 1; i < rowLength; i++){
       ...
       for(var j = 0; j < cellLength; j++){
           ...
           var name ;
           if(j==0 ){
        	   name = "gHGInputGrasslandList["+x+"].landcategory";
           }
           if(j==1){
        	   name = "gHGInputGrasslandList["+x+"].area";
           }
           if(j==2){
        	   name = "gHGInputGrasslandList["+x+"].emissions";
           }
           if(j==3){
         	  name = "gHGInputGrasslandList["+x+"].reference";
            }
...
function getData(){
	...
	var url = '/getGHGInputGrasslandExisting?sector=' + sector + '&subSector='+subSector  + '&category='+category + '&subCategory='+subCategory + '&year='+year + '&status=ANY';
...
function setStatus(id){
	...
	<% if(existingGHGInputGrassland!=null && !existingGHGInputGrassland.isEmpty()) { %>
	document.getElementById('dataId').value = "<%=existingGHGInputGrassland.get(0).getDataId()%>";
	<% } %>
}
...
<% if(existingGHGInputGrassland!=null && !existingGHGInputGrassland.isEmpty()) {
	%>
		...
		document.getElementById('calcApproach').value = "<%=existingGHGInputGrassland.get(0).getCalcApproach()%>";
	<%
		} else {
	%>
