...
%>	   
	   <script>alert("email Id already in use. Please use a different email id or use forgot password/ contact System Administrator");</script> 	
...
<body class="navbar-top">
	...
	<!-- Main navbar -->
		<!-- /main navbar -->
<div class="navbar navbar-expand-md navbar-light bg-pink-600 fixed-top">
		<div class="navbar-brand">
			<!-- <a href="index.html" class="d-inline-block">
				<img src="global_assets/images/ssudan.png">
			</a> -->
		</div>
...
<ul class="navbar-nav">
					...
					<li class="nav-item" style="margin-left:40px; margin-top:10px">
						
						<h4><a href="Login.jsp" class="navbar-nav-link text-white text-uppercase"><i class="icon-home mr-2 font-weight-bold"></i>
							South Sudan's Climate Action Impact Assessment MRV Tool</a></h4>
							...
							<div class="card mb-0">
								<div class="card-body">
									<div class="text-center mb-3">
										<i class="icon-plus3 icon-1x text-pink border-pink border-3 rounded-round p-3 mb-3 mt-1"></i>
								...
								<div class="form-group row">
									...
									<div class="col-md-4">
									<span class="text-uppercase"><b>Projects</b></span>
									<div class="form-group">
									<br>
										<div class="form-check">
											<label class="form-check-label">
									...
									<button type="submit" class="btn bg-pink-600 btn-labeled btn-labeled-right"><b><i class="icon-plus3"></i></b> Create account</button>
								</div>
							</div>
						</div>
					</div>
