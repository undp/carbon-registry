...
List<GHGInputOtherLand> existingGHGInputOtherLand = null;

if(request.getAttribute("existingGHGInputOtherLand")!=null){
	existingGHGInputOtherLand = (List<GHGInputOtherLand>)request.getAttribute("existingGHGInputOtherLand");
...
<div class="card border-pink">
	<div class="card-header bg-pink-600">
		<h5 class="card-title text-uppercase text-center">GHG Inventory - Other Lands</h5>
	</div>

	<div class="card-body">
	<form action="saveGHGInputOtherLand" method="post" onsubmit="return setValues();" class="form-horizontal bordered-row" id="ghgInputForm" data-parsley-validate="">
...
<div class="form-group">
      				<div class="card">
                    <div class="card-body">
      <h6 class="card-title">Other Lands Data</h6>
					<div class="table-responsive">
						<table id="ghgTable1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <c:choose>
							<c:when test = "${empty existingGHGInputOtherLand}">
                            <tr>
                                <td>Other Lands Remaining Other Lands </td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Forest Land converted to Other Lands</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Cropland converted to Other Lands</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Wetlands converted to Other Lands</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Settlements converted to Other Lands</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Grassland converted to Other Lands</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
								<td contenteditable='true'></td>
                                </tr>
							...
							<c:forEach var="output" varStatus="loop" items="${existingGHGInputOtherLand}">
							    <tr>
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="remarks">${existingGHGInputOtherLand[0].getRemarks()}</textarea>
     </div>
</div>
...
function setValues(){
    ...
    for (i = 1; i < rowLength; i++){
       ...
       for(var j = 0; j < cellLength; j++){
           ...
           var name ;
           if(j==0 ){
        	   name = "ghgInputOtherLandList["+x+"].landcategory";
           }
           if(j==1){
        	   name = "ghgInputOtherLandList["+x+"].area";
           }
           if(j==2){
        	   name = "ghgInputOtherLandList["+x+"].emissions";
           }
           if(j==3){
         	  name = "ghgInputOtherLandList["+x+"].reference";
            }
...
function getData(){
	...
	var url = '/getGHGInputOtherLandExisting?sector=' + sector + '&subSector='+subSector  + '&category='+category + '&subCategory='+subCategory + '&year='+year + '&status=ANY';
...
function setStatus(id){
	...
	<% if(existingGHGInputOtherLand!=null && !existingGHGInputOtherLand.isEmpty()) { %>
	document.getElementById('dataId').value = "<%=existingGHGInputOtherLand.get(0).getDataId()%>";
	<% } %>
}
...
<% if(existingGHGInputOtherLand!=null && !existingGHGInputOtherLand.isEmpty()) {
	%>
		...
		document.getElementById('calcApproach').value = "<%=existingGHGInputOtherLand.get(0).getCalcApproach()%>";
	<%
		} else {
	%>
