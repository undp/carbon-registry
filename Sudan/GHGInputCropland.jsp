...
List<GHGInputCropland> existingGHGInputCropland = null;

if(request.getAttribute("existingGHGInputCropland")!=null){
	existingGHGInputCropland = (List<GHGInputCropland>)request.getAttribute("existingGHGInputCropland");
...
<div class="card border-pink">
	<div class="card-header bg-pink-600">
		<h5 class="card-title text-uppercase text-center">GHG Inventory - Cropland</h5>
	</div>

	<div class="card-body">
	<form action="saveGHGInputCropland" method="post" onsubmit="return setValues();" class="form-horizontal bordered-row" id="ghgInputForm" data-parsley-validate="">
...
<div class="form-group">
      				<div class="card">
                    <div class="card-body">
      <h6 class="card-title">Cropland Data</h6>
					<div class="table-responsive">
						<table id="ghgTable1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <c:choose>
							<c:when test = "${empty existingGHGInputCropland}">
								<tr>
                                <td>Cropland Remaining Cropland</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
								<td contenteditable='true'></td>
							    </tr>
                                <tr>
                                <td>Forest Land converted to Cropland</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Grassland converted to Cropland</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Wetlands converted to Cropland</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Settlements converted to Cropland</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Other Land converted to Cropland</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true"></td>
								<td contenteditable='true'></td>
                                </tr>
							...
							<c:forEach var="output" varStatus="loop" items="${existingGHGInputCropland}">
							    <tr>
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="remarks">${existingGHGInputCropland[0].getRemarks()}</textarea>
     </div>
</div>
...
function setValues(){
    ...
    for (i = 1; i < rowLength; i++){
       ...
       for(var j = 0; j < cellLength; j++){
           ...
           var name ;
           if(j==0 ){
        	   name = "gHGInputCroplandList["+x+"].landcategory";
           }
           if(j==1){
        	   name = "gHGInputCroplandList["+x+"].area";
           }
           if(j==2){
        	   name = "gHGInputCroplandList["+x+"].emissions";
           }
           if(j==3){
         	  name = "gHGInputCroplandList["+x+"].reference";
            }
...
function getData(){
	...
	var url = '/getGHGInputCroplandExisting?sector=' + sector + '&subSector='+subSector  + '&category='+category + '&subCategory='+subCategory + '&year='+year + '&status=ANY';
...
function setStatus(id){
	...
	<% if(existingGHGInputCropland!=null && !existingGHGInputCropland.isEmpty()) { %>
	document.getElementById('dataId').value = "<%=existingGHGInputCropland.get(0).getDataId()%>";
	<% } %>
}
<% if(existingGHGInputCropland!=null && !existingGHGInputCropland.isEmpty()) {
	%>
		document.getElementById('fourEyesStatus').value = 'Pending_Update';
		document.getElementById('calcApproach').value = "<%=existingGHGInputCropland.get(0).getCalcApproach()%>";
	<%
		} else {
	%>
