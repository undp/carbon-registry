...
<div class="content">
	...
	<div class="card-body">										
<form action="saveLivestockDatabase" onsubmit="return setValues();" method="post" class="form-horizontal bordered-row" id="livestockEFForm" data-parsley-validate="">
<div class="table-responsive">
                   ...
                   <button type="button" class="btn btn-sm bg-pink-600" data-toggle="modal" data-target="#modal_form_vertical">Add Row</button><hr>              
   ...
   <div class="col-lg-1">
   <br>
   <button type="button" class="btn btn-sm bg-pink-600 add-row1">Add</button></div></div>
...
function setValues(){
    ...
    for (i = 1; i < rowLength; i++){
       ...
       for(var j = 0; j < cellLength; j++){
           ...
           var name ;
           if(j==0 ){
        	   name = "livestockDatabaseList["+x+"].animalcategory";
           }
           if(j==1){
        	   name = "livestockDatabaseList["+x+"].efef";
           }
           if(j==2){
        	   name = "livestockDatabaseList["+x+"].efmm";
        	   
           }
           if(j==3){
        	   name = "livestockDatabaseList["+x+"].ner";
        	   
           }
           if(j==4){
        	   name = "livestockDatabaseList["+x+"].animalMass";
        	   
           }
           if(j==5){
        	   name = "livestockDatabaseList["+x+"].nem";
    	   }
           if(j==6){
        	   name = "livestockDatabaseList["+x+"].efd";
    	   }
           if(j==7){
        	   name = "livestockDatabaseList["+x+"].mmLost";
    	   }
           
           if(j==8){
        	   name = "livestockDatabaseList["+x+"].fracVol";
    	   }
           
           if(j==9){
        	   name = "livestockDatabaseList["+x+"].efAtm";
    	   }
           
           if(j==10){
         	  name = "livestockDatabaseList["+x+"].reference";
            }
