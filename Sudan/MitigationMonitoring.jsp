...
<div class="card-body font-size-lg">
  ...
  <div class="form-group row">
   ...
   <div class="col-lg-3">
  <input class="form-control" readonly="readonly" type="date" name="project.endDate" id="id-date-picker-1" value = "${existingMitigationMonitoring.project.endDate}">
   </div>
  ...
  <div class="form-group row">
   ...
   <div class="col-lg-3">
   <input name="mitigationInput.verification" id="verificationStatus" readonly="readonly" class="form-control" placeholder="" value="${existingMitigationMonitoring.mitigationInput.verification}">
   </div>
   </div>
   <!-- <div class="form-group row">
