...
<div class="card-body">
					<table class="table table-bordered table-striped datatable-button-html5-basic">
						<thead>
							<tr class="font-size-lg bg-pink-600">
								<th>User Name</th>
								<th>Email</th>
								<th>Permissions</th>
								<th>Role</th>
			...
			<a
				...
				id='Approved' onclick="setStatus(this.id);" data-toggle="tooltip" title="Approve"><button type="button" class="btn"><i class="fas fa-user-check fa-1x  mr-3"></i>Approve</button></a>
				
				
			<a href="${pageContext.request.contextPath }/adminForm/rejected/${output.dataId}"
				id='Rejected' onclick="setStatus(this.id);" data-toggle="tooltip" title="Reject"><button type="button" class="btn"><i class="fas fa-user-times fa-1x  mr-3"></i>Reject</button></a></div></div></td></c:when>
			<c:otherwise>
			<td><a
				href="${pageContext.request.contextPath }/adminForm/delete/${output.dataId}"
				id='Deleted' onclick="return confirm('Are you sure you want to delete this user?')" data-toggle="tooltip" title="Delete"><button type="button" class="btn"><i class="fas fa-user-slash fa-1x mr-3"></i> Delete</button></a>
				</td>
