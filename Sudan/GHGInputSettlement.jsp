...
List<GHGInputSettlement> existingGHGInputSettlement = null;

if(request.getAttribute("existingGHGInputSettlement")!=null){
	existingGHGInputSettlement = (List<GHGInputSettlement>)request.getAttribute("existingGHGInputSettlement");
...
<div class="card border-pink">
	<div class="card-header bg-pink-600">
		<h5 class="card-title text-uppercase text-center">GHG Inventory - Settlements</h5>
	</div>

	<div class="card-body">
	<form action="saveGHGInputSettlement" method="post" onsubmit="return setValues();" class="form-horizontal bordered-row" id="ghgInputForm" data-parsley-validate="">
...
<div class="form-group">
      				<div class="card">
                    <div class="card-body">
      <h6 class="card-title">Settlements Data</h6>
					<div class="table-responsive">
						<table id="ghgTable1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <c:choose>
							<c:when test = "${empty existingGHGInputSettlement}">
                            <tr>
                                <td>Settlements Remaining Settlements </td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Forest Land converted to Settlements</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Cropland converted to Settlements</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Grassland converted to Settlements</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Wetlands converted to Settlements</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
								<td contenteditable='true'></td>
                                </tr>
                                <tr>
                                <td>Other Land converted to Settlements</td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
                                <td contenteditable='true' class ="input-mask-trigger" data-inputmask="'alias': 'decimal', 'autoGroup': true" im-insert="true""></td>
								<td contenteditable='true'></td>
                                </tr>
							...
							<c:forEach var="output" varStatus="loop" items="${existingGHGInputSettlement}">
							    <tr>
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="remarks">${existingGHGInputSettlement[0].getRemarks()}</textarea>
     </div>
</div>
...
<div class="col-sm-12">
<textarea class="form-control" id="approverRemarks" name="approverRemarks" placeholder=""></textarea>
</div>
</div>
</div>
...
function setValues(){
    ...
    for (i = 1; i < rowLength; i++){
       ...
       for(var j = 0; j < cellLength; j++){
           ...
           var name ;
           if(j==0 ){
        	   name = "ghgInputSettlementList["+x+"].landcategory";
           }
           if(j==1){
        	   name = "ghgInputSettlementList["+x+"].area";
           }
           if(j==2){
        	   name = "ghgInputSettlementList["+x+"].emissions";
           }
           if(j==3){
         	  name = "ghgInputSettlementList["+x+"].reference";
            }
...
function getData(){
	...
	var url = '/getGHGInputSettlementExisting?sector=' + sector + '&subSector='+subSector  + '&category='+category + '&subCategory='+subCategory + '&year='+year + '&status=ANY';
...
function setStatus(id){
	...
	<% if(existingGHGInputSettlement!=null && !existingGHGInputSettlement.isEmpty()) { %>
	document.getElementById('dataId').value = "<%=existingGHGInputSettlement.get(0).getDataId()%>";
	<% } %>
}
...
<% if(existingGHGInputSettlement!=null && !existingGHGInputSettlement.isEmpty()) {
	%>
		...
		document.getElementById('calcApproach').value = "<%=existingGHGInputSettlement.get(0).getCalcApproach()%>";
	<%
		} else {
	%>
