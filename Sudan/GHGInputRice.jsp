...
<div class="col-sm-12">
				<textarea class="form-control" id="remarks" name="remarks">${existingGHGInputRice[0].getRemarks()}</textarea>
     </div>
</div>
...
function setStatus(id){
	...
	%>
		...
		document.getElementById('calcApproach').value = "<%=existingGHGInputRice.get(0).getCalcApproach()%>";
	<%
		} else {
	%>
