...
<%@page import="com.sudan.model.sdg.SDGOutputCount"%>
...
<%DateFormat formatter1 = new SimpleDateFormat("dd/MM/yyyy"); %>
	...
	<title>SDG Tracking Report (Generated on <%= formatter1.format(new Date())%>)</title>
	<!-- Global stylesheets -->
...
<div class="card border-pink">
	<div class="card-header bg-pink-600">
		<h5 class="card-title text-center">SDG Tracking Report</h5>
	</div>
	<div class="card-body">
	  			<div class="card">
	  			    <div class="card-body">
