...
<div class="card-body font-size-lg">
  ...
  <div class="form-group row">
   ...
   <div class="col-lg-3">
  <input class="form-control" readonly="readonly" type="date" name="project.endDate" id="id-date-picker-1" value = "${existingMitigationInput.project.endDate}">
   </div>
  ...
  <div class="form-group row">
  <label class="col-lg-2 col-form-label text-right">Expected GHG Savings (tCO<sub>2</sub>e/ year)&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
   ...
   <label class="col-lg-2 col-form-label text-right">Target GHGs&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
   ...
   <div class="form-group row">
   <label class="col-lg-2 col-form-label text-right">Project Contributions&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
   ...
   <label class="col-lg-2 col-form-label text-right">Project Status&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
  ...
  <div class="form-group row">
   <label class="col-lg-2 col-form-label text-right">Project Beneficiaries&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
   ...
   <label class="col-lg-2 col-form-label text-right">Gender Inclusiveness Assessment&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
   ...
   <div class="form-group row">
   <label class="col-lg-2 col-form-label text-right">Expected Project Outputs&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
   ...
   <label class="col-lg-2 col-form-label text-right">Project Impacts&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
   ...
   <div class="form-group row">
   <label class="col-lg-2 col-form-label text-right">Registered With Market Based Mechanism&nbsp<span class="text-danger">*</span></label>
   <div class="col-lg-3">
   <select name="mitigationInput.marketMech" required id ="marketMech" class="form-control select" data-placeholder="--Select--" data-focu>
   <option></option>
     <option value="Yes">Yes</option>
	 <option value="No">No</option>
	 <option value="NA">Not Applicable</option>
   ...
   <div class="col-lg-3">
  <input class="form-control" readonly="readonly" name="napa" value = "${existingMitigationInput.project.napa}">
   </div>
   ...
   <div class="card">
      ...
      <h6 class="card-title text-uppercase text-pink-600">Performance Indicators</h6>
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="mitigationInput.remarks">${existingMitigationInput.getMitigationInput().getRemarks()}</textarea>
     </div>
</div>
...
document.getElementById('marketMech').value = "<%=mitigationInput.getMarketMech()%>";
</script>
<% } %>
<script>
