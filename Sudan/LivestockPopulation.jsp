...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="remarks">${livestockPopulation[0].getRemarks()}</textarea>
     </div>
</div>
...
<button id = "Approved" class="btn bg-pink-600">Approve</button>
</div>
</div>
</div>
</div>
...
<button id = "Rejected" class="btn bg-pink-600">Reject</button>
</div> 
</div>
</div>
