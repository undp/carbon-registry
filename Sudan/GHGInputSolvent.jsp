<%@page import="com.sudan.model.ghg.ippu.GHGInputSolvent"%>
...
<div class="form-group">
      ...
      <h6 class="card-title">Solvent Use Data</h6>
					<div class="table-responsive">
                        ...
                        <hr>
                          <h6 class="card-title">Add Solvent</h6>
                        <div class="form-group row">
...
<div class="col-sm-12">
<textarea class="form-control" id="remarks" name="remarks">${existingGHGInputSolvent[0].getRemarks()}</textarea>
     </div>
</div>
...
<% if(existingGHGInputSolvent!=null && !existingGHGInputSolvent.isEmpty()) {
	%>
		...
		document.getElementById('calcApproach').value = "<%=existingGHGInputSolvent.get(0).getCalcApproach()%>";
	<%
		} else {
	%>
