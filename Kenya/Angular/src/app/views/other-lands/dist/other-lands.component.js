...
exports.OtherLandsComponent = void 0;
var collections_1 = require("@angular/cdk/collections");
var core_1 = require("@angular/core");
var forms_1 = require("@angular/forms");
var material_1 = require("@angular/material");
var snackbar_dialog_component_1 = require("../modal/snackbar-dialog/snackbar-dialog.component");
var OtherLandsComponent = /** @class */ (function () {
    function OtherLandsComponent(_fb, _activatedRoute, _snackBar, router, appService) {
        this._fb = _fb;
        ...
        this.formGroup = this._fb.group({
            ...
            subSector: ['3.B.6-Other Land', [forms_1.Validators.required]],
            category: ['3.B-Land', [forms_1.Validators.required]],
            calculationApproach: ['Tier I', [forms_1.Validators.required]]
        });
    }
    OtherLandsComponent_1 = OtherLandsComponent;
    Object.defineProperty(OtherLandsComponent.prototype, "matSort", {
        set: function (ms) {
            this.sort = ms;
    ...
    Object.defineProperty(OtherLandsComponent.prototype, "matPaginator", {
        set: function (mp) {
            this.paginator = mp;
            this.setDataSourceAttributes();
        },
    ...
    OtherLandsComponent.prototype.loadActivityData = function (type, value) {
        var _a;
        var _this = this;
        var obj = (_a = {
                menuId: OtherLandsComponent_1.Constants.MENU_ID
            },
            _a[type] = value,
            _a);
        // this.dataList = [];
    ...
    OtherLandsComponent.prototype.getPermissionMenuId = function () {
        var _this = this;
        this.appService.getRecord(OtherLandsComponent_1.Constants.MENU_ID).subscribe(function (res) {
            if (res.data) {
                _this.menu = res.data;
            }
        }, function (err) {
    ...
    OtherLandsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.yearList = [];
        this.getYears();
    ...
    OtherLandsComponent.prototype.getYears = function () {
        var _this = this;
    ...
    OtherLandsComponent.prototype.isInvalid = function (form, field, errorValue) {
    ...
    OtherLandsComponent.prototype.setDataSourceAttributes = function () {
        this.dataSource.paginator = this.paginator;
        this.dataSource.sort = this.sort;
    };
    OtherLandsComponent.prototype.ngAfterViewInit = function () {
        this.dataSource.paginator = this.paginator;
    };
    OtherLandsComponent.prototype.applyFilter = function (filterValue) {
        var filter = {
    ...
    OtherLandsComponent.prototype.customFilterPredicate = function () {
    ...
    OtherLandsComponent.prototype.isAllSelected = function () {
        var numSelected = this.selection.selected.length;
        var numRows = this.dataSource.data.length;
        return numSelected === numRows;
    };
    OtherLandsComponent.prototype.isAllNewSelected = function () {
        var numSelected = this.newSelection.selected.length;
        var numRows = this.newDataSource.data.length;
        return numSelected === numRows;
    };
    /** Selects all rows if they are not all selected; otherwise clear selection. */
    OtherLandsComponent.prototype.masterToggle = function () {
        var _this = this;
        this.isAllSelected() ?
            this.selection.clear() :
            this.dataSource.data.forEach(function (row) { return _this.selection.select(row); });
    };
    OtherLandsComponent.prototype.masterToggleNew = function () {
        var _this = this;
    ...
    OtherLandsComponent.prototype.checkboxLabel = function (row) {
        if (!row) {
            return (this.isAllSelected() ? 'select' : 'deselect') + " all";
        }
        return (this.selection.isSelected(row) ? 'deselect' : 'select') + " row " + (row.position + 1);
    };
    OtherLandsComponent.prototype.checkboxLabelNew = function (row) {
        if (!row) {
    ...
    OtherLandsComponent.prototype.addNewRow = function () {
    ...
    OtherLandsComponent.prototype.removeIndividuallyFromList = function (list, ele) {
        if (list === 'exist') {
    ...
    OtherLandsComponent.prototype.removeSelected = function (list) {
        if (list === 'exist') {
    ...
    OtherLandsComponent.prototype.openSnackBar = function (message, type) {
    ...
    OtherLandsComponent.prototype.saveElectricityGeneration = function () {
        var _this = this;
        var obj = {
    ...
    OtherLandsComponent.prototype.updateDataStaus = function (status) {
        var _this = this;
        var obj = {
            status: status,
    ...
    var OtherLandsComponent_1;
    OtherLandsComponent.Constants = {
        MENU_ID: 'GHG_AFOLU_Land_OtherLands'
    };
    __decorate([
        core_1.ViewChild(material_1.MatSort, { static: false })
    ], OtherLandsComponent.prototype, "matSort");
    __decorate([
        core_1.ViewChild(material_1.MatPaginator, { static: false })
    ], OtherLandsComponent.prototype, "matPaginator");
    OtherLandsComponent = OtherLandsComponent_1 = __decorate([
        core_1.Component({
    ...
    return OtherLandsComponent;
}());
exports.OtherLandsComponent = OtherLandsComponent;
