...
exports.ManufacturingComponent = void 0;
...
var ManufacturingComponent =
/** @class */
function () {
  function ManufacturingComponent(_fb, _ms, _activatedRoute, _snackBar, _router, appService) {
    this._fb = _fb;
    this._ms = _ms;
    ...
    this.formGroup = this._fb.group({
      ...
      subSector: ['1.A.2-Manufacturing Industries and Construction', [forms_1.Validators.required]],
  ...
  ManufacturingComponent_1 = ManufacturingComponent;
  Object.defineProperty(ManufacturingComponent.prototype, "matSort", {
    set: function set(ms) {
      this.sort = ms;
  ...
  Object.defineProperty(ManufacturingComponent.prototype, "matPaginator", {
    set: function set(mp) {
      this.paginator = mp;
      this.setDataSourceAttributes();
    },
  ...
  ManufacturingComponent.prototype.getPermissionMenuId = function () {
    var _this = this;

    this.appService.getRecord(ManufacturingComponent_1.Constants.MENU_ID).subscribe(function (res) {
      if (res.data) {
  ...
  ManufacturingComponent.prototype.loadActivityData = function (type, value) {
    var _a;

    var _this = this;

    var obj = (_a = {
      menuId: ManufacturingComponent_1.Constants.MENU_ID
    }, _a[type] = value, _a);
  ...
  ManufacturingComponent.prototype.getYears = function () {
    var _this = this;

    this._ms.getInventoryYears().subscribe(function (res) {
  ...
  ManufacturingComponent.prototype.getFuelTypes = function () {
    var _this = this;

    this._ms.getFuelTypes().subscribe(function (res) {
      if (res.statusCode == 200) {
  ...
  ManufacturingComponent.prototype.isInvalid = function (form, field, errorValue) {
  ...
  ManufacturingComponent.prototype.setDataSourceAttributes = function () {
    this.dataSource.paginator = this.paginator;
    this.dataSource.sort = this.sort;
  };

  ManufacturingComponent.prototype.ngAfterViewInit = function () {
    this.dataSource.paginator = this.paginator;
  };

  ManufacturingComponent.prototype.applyFilter = function (filterValue) {
    var filter = {
  ...
  ManufacturingComponent.prototype.customFilterPredicate = function () {
  ...
  ManufacturingComponent.prototype.getFuelsByType = function (fuel, id) {
    var _this = this;

    this._ms.getFuelByType(fuel).subscribe(function (res) {
      if (res.statusCode == 200) {
  ...
  ManufacturingComponent.prototype.isAllSelected = function () {
    var numSelected = this.selection.selected.length;
    var numRows = this.dataSource.data.length;
    return numSelected === numRows;
  };

  ManufacturingComponent.prototype.isAllNewSelected = function () {
  ...
  ManufacturingComponent.prototype.masterToggle = function () {
    var _this = this;
  ...
  ManufacturingComponent.prototype.masterToggleNew = function () {
    var _this = this;
  ...
  ManufacturingComponent.prototype.checkboxLabel = function (row) {
    if (!row) {
  ...
  ManufacturingComponent.prototype.checkboxLabelNew = function (row) {
    if (!row) {
  ...
  ManufacturingComponent.prototype.addNewRow = function () {
  ...
  ManufacturingComponent.prototype.removeIndividuallyFromList = function (list, ele) {
    if (list == 'exist') {
  ...
  ManufacturingComponent.prototype.removeSelected = function (list) {
    if (list == 'exist') {
  ...
  ManufacturingComponent.prototype.openSnackBar = function (message, type) {
  ...
  ManufacturingComponent.prototype.saveElectricityGeneration = function () {
    var _this = this;
  ...
  ManufacturingComponent.prototype.updateDataStaus = function (status) {
    var _this = this;
    ...
    this._ms.updateDataStatus(obj).subscribe(function (res) {
      if (res.statusCode == 200) {
        _this.openSnackBar(res.message, 'success');

        _this._router.navigate(['ghg/energy/Sectoral_Approach/Manufacturing']);
      } else {
        _this.openSnackBar(res.message, 'error');
      }
    }, function (err) {
  ...
  var ManufacturingComponent_1;
  ManufacturingComponent.Constants = {
    MENU_ID: 'GHG_Energy_Sectoral_Approach_Manufacturing'
  };

  __decorate([core_1.ViewChild(material_1.MatSort, {
    "static": false
  })], ManufacturingComponent.prototype, "matSort");

  __decorate([core_1.ViewChild(material_1.MatPaginator, {
    "static": false
  })], ManufacturingComponent.prototype, "matPaginator");

  ManufacturingComponent = ManufacturingComponent_1 = __decorate([core_1.Component({
