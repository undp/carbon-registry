...
export class EntericFermentationComponent implements OnInit {
  ...
  setFormValue(dataInput: any) {
    ...
    this.dataList =dataInput.entericFermentationData;
  }
  ngOnInit() {
...
private setDataTableConfig() {
    ...
    this.dataTableTitle = "Enteric Fermentation";
  ...
  save() {
    ...
    const obj = {
      ...
      entericFermentationData: this.dataList,
