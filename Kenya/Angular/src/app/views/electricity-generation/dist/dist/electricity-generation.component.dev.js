...
var ElectricityGenerationComponent =
/** @class */
function () {
  function ElectricityGenerationComponent(_fb, _egs, _activatedRoute, _snackBar, _router, appService) {
    this._fb = _fb;
    this._egs = _egs;
  ...
  ElectricityGenerationComponent.prototype.updateDataStaus = function (status) {
    ...
    this._egs.updateDataStatus(obj).subscribe(function (res) {
      if (res.statusCode == 200) {
        ...
        _this._router.navigate(['ghg/energy/Sectoral_Approach/Energy_Industries/Electricity_Generation']);
      } else {
        _this.openSnackBar(res.message, 'error');
      }
    }, function (err) {
  ...
  ElectricityGenerationComponent = ElectricityGenerationComponent_1 = __decorate([core_1.Component({
