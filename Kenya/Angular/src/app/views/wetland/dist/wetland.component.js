...
exports.WetlandComponent = void 0;
var collections_1 = require("@angular/cdk/collections");
var core_1 = require("@angular/core");
var forms_1 = require("@angular/forms");
var material_1 = require("@angular/material");
var snackbar_dialog_component_1 = require("../modal/snackbar-dialog/snackbar-dialog.component");
var WetlandComponent = /** @class */ (function () {
    function WetlandComponent(_fb, _activatedRoute, _snackBar, router, appService) {
        this._fb = _fb;
        ...
        this.dataList = [
            { forestCategory: 'Wetlands Remaining Wetlands', area: 0, ghgEmissions: 0, reference: '' },
            { forestCategory: 'Forest Land converted to Wetlands', area: 0, ghgEmissions: 0, reference: '' },
            { forestCategory: 'Cropland converted to Wetlands', area: 0, ghgEmissions: 0, reference: '' },
            { forestCategory: 'Grassland converted to Wetlands', area: 0, ghgEmissions: 0, reference: '' },
            { forestCategory: 'Settlements converted to Wetlands', area: 0, ghgEmissions: 0, reference: '' },
            { forestCategory: 'Other Land converted to Wetlands', area: 0, ghgEmissions: 0, reference: '' }
        ];
        this.newlyAddedList = [];
        ...
        this.formGroup = this._fb.group({
            ...
            subSector: ['3.B.4-Wetlands', [forms_1.Validators.required]],
            category: ['3.B-Land', [forms_1.Validators.required]],
            calculationApproach: ['Tier I', [forms_1.Validators.required]]
        });
    }
    WetlandComponent_1 = WetlandComponent;
    Object.defineProperty(WetlandComponent.prototype, "matSort", {
        set: function (ms) {
            this.sort = ms;
    ...
    Object.defineProperty(WetlandComponent.prototype, "matPaginator", {
        set: function (mp) {
            this.paginator = mp;
            this.setDataSourceAttributes();
        },
    ...
    WetlandComponent.prototype.loadActivityData = function (type, value) {
        var _a;
        var _this = this;
        var obj = (_a = {
                menuId: WetlandComponent_1.Constants.MENU_ID
            },
            _a[type] = value,
            _a);
        // this.dataList = [];
    ...
    WetlandComponent.prototype.getPermissionMenuId = function () {
        var _this = this;
        this.appService.getRecord(WetlandComponent_1.Constants.MENU_ID).subscribe(function (res) {
            if (res.data) {
                _this.menu = res.data;
            }
        }, function (err) {
    ...
    WetlandComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.yearList = [];
        this.getYears();
    ...
    WetlandComponent.prototype.getYears = function () {
        var _this = this;
    ...
    WetlandComponent.prototype.isInvalid = function (form, field, errorValue) {
    ...
    WetlandComponent.prototype.setDataSourceAttributes = function () {
        this.dataSource.paginator = this.paginator;
        this.dataSource.sort = this.sort;
    };
    WetlandComponent.prototype.ngAfterViewInit = function () {
        this.dataSource.paginator = this.paginator;
    };
    WetlandComponent.prototype.applyFilter = function (filterValue) {
        var filter = {
    ...
    WetlandComponent.prototype.customFilterPredicate = function () {
    ...
    WetlandComponent.prototype.isAllSelected = function () {
        var numSelected = this.selection.selected.length;
        var numRows = this.dataSource.data.length;
        return numSelected === numRows;
    };
    WetlandComponent.prototype.isAllNewSelected = function () {
        var numSelected = this.newSelection.selected.length;
        var numRows = this.newDataSource.data.length;
        return numSelected === numRows;
    };
    /** Selects all rows if they are not all selected; otherwise clear selection. */
    WetlandComponent.prototype.masterToggle = function () {
        var _this = this;
        this.isAllSelected() ?
            this.selection.clear() :
            this.dataSource.data.forEach(function (row) { return _this.selection.select(row); });
    };
    WetlandComponent.prototype.masterToggleNew = function () {
        var _this = this;
    ...
    WetlandComponent.prototype.checkboxLabel = function (row) {
        if (!row) {
            return (this.isAllSelected() ? 'select' : 'deselect') + " all";
        }
        return (this.selection.isSelected(row) ? 'deselect' : 'select') + " row " + (row.position + 1);
    };
    WetlandComponent.prototype.checkboxLabelNew = function (row) {
        if (!row) {
    ...
    WetlandComponent.prototype.addNewRow = function () {
    ...
    WetlandComponent.prototype.removeIndividuallyFromList = function (list, ele) {
        if (list === 'exist') {
    ...
    WetlandComponent.prototype.removeSelected = function (list) {
        if (list === 'exist') {
    ...
    WetlandComponent.prototype.openSnackBar = function (message, type) {
    ...
    WetlandComponent.prototype.saveElectricityGeneration = function () {
        var _this = this;
        var obj = {
    ...
    WetlandComponent.prototype.updateDataStaus = function (status) {
        var _this = this;
        var obj = {
            status: status,
    ...
    var WetlandComponent_1;
    WetlandComponent.Constants = {
        MENU_ID: 'GHG_AFOLU_Land_Wetland'
    };
    __decorate([
        core_1.ViewChild(material_1.MatSort, { static: false })
    ], WetlandComponent.prototype, "matSort");
    __decorate([
        core_1.ViewChild(material_1.MatPaginator, { static: false })
    ], WetlandComponent.prototype, "matPaginator");
    WetlandComponent = WetlandComponent_1 = __decorate([
        core_1.Component({
            selector: 'app-wetland',
            templateUrl: './wetland.component.html',
            styleUrls: ['./wetland.component.scss']
        })
    ], WetlandComponent);
    return WetlandComponent;
}());
exports.WetlandComponent = WetlandComponent;
