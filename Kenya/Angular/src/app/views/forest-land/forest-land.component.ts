...
import { ManureManagementComponent } from '../manure-management/manure-management.component';
...
export class ForestLandComponent implements OnInit {
  ...
  setFormValue(dataInput: any) {
    ...
    // set other values mannually
          this.dataList.forEach(data => {
            dataInput.forestData.forEach(element => {
